			...
			<div class="flex flex-col">
				...
				get_template_part(
					...
					array(
						...
						'class'         => 'mt-0 w-full appearance-auto rounded-lg bg-filters-background px-3 py-2.5! text-sm text-filters-text shadow-main! border-none! focus:outline-none focus-visible:ring-0 focus-visible:ring-filters-link/50',
						'label'         => '',
						'label_sr_only' => true,
