					...
					<div id="primary-menu-panel" class="primary-menu-panel hidden md:flex md:flex-row md:items-center md:gap-6"
						...
						wp_nav_menu(
							array(
								...
								'container'      => false,
								'menu_class'     => 'primary-menu-panel__list flex flex-col gap-6 md:flex-row md:items-center md:gap-6 md:text-sm md:px-4 [&_a]:no-underline [&_a]:font-bold [&_a]:text-brand',
								'fallback_cb'    => false,
							)
						);
						?>
